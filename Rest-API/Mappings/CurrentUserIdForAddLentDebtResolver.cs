...
namespace Rest_API.Mappings
{
    public class CurrentUseridForAddLentDebtResolver : IValueResolver<AddLentDebt, Debt, int>
    {
        ...
        public CurrentUseridForAddLentDebtResolver(IHttpContextAccessor httpContextAccessor)
        {
            _httpContextAccessor = httpContextAccessor;
        }

        public int Resolve(AddLentDebt addLentDebt, Debt debt, int borrowerId, ResolutionContext context) =>
